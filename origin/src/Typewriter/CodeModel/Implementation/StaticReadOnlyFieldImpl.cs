...
{
    public class StaticReadOnlyFieldImpl : StaticReadOnlyField
    {
        private readonly IStaticReadOnlyFieldMetadata _metadata;

        private StaticReadOnlyFieldImpl(IStaticReadOnlyFieldMetadata metadata, Item parent, Settings settings)
        {
            _metadata = metadata;
            Parent = parent;
            Settings = settings;
        ...
        public static IStaticReadOnlyFieldCollection FromMetadata(IEnumerable<IStaticReadOnlyFieldMetadata> metadata, Item parent, Settings settings)
        {
            return new StaticReadOnlyFieldCollectionImpl(metadata.Select(c => new StaticReadOnlyFieldImpl(c, parent, settings)));
        }
    }
}